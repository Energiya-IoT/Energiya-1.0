...
void Init_8Inputs()
{
	...
	le_result_t Res = io_CreateOutput("addon_gpio/i2c_address", IO_DATA_TYPE_NUMERIC, "");
	if (Res != LE_OK)
	{
	...
	{
		io_SetNumericDefault("addon_gpio/i2c_address", 0);
	}
	AddressHandlerGPIO_I2C = io_AddNumericPushHandler("addon_gpio/i2c_address", HandleSettingsAddressPush, NULL);
