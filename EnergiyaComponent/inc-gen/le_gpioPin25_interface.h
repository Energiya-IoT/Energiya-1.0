...
#ifndef LE_GPIOPIN25_INTERFACE_H_INCLUDE_GUARD
#define LE_GPIOPIN25_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_gpioPin25_DisconnectHandler_t)(void *);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin25_ConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin25_TryConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin25_SetServerDisconnectHandler
(
    le_gpioPin25_DisconnectHandler_t disconnectHandler,
    void *contextPtr
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin25_DisconnectService
(
    void
);
...
typedef enum
{
    LE_GPIOPIN25_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    LE_GPIOPIN25_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
le_gpioPin25_Polarity_t;
...
typedef enum
{
    LE_GPIOPIN25_EDGE_NONE = 0,
        ///< No edge detection
    LE_GPIOPIN25_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    LE_GPIOPIN25_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    LE_GPIOPIN25_EDGE_BOTH = 3
...
//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'le_gpioPin25_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct le_gpioPin25_ChangeEventHandler* le_gpioPin25_ChangeEventHandlerRef_t;
...
typedef enum
{
    LE_GPIOPIN25_PULL_OFF = 0,
        ///< Neither resistor is enabled
    LE_GPIOPIN25_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    LE_GPIOPIN25_PULL_UP = 2
        ///< Pullup resistor is enabled
}
le_gpioPin25_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_gpioPin25_ChangeCallbackFunc_t)
(
    bool state,
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'le_gpioPin25_ChangeEvent'
 *
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'le_gpioPin25_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin25_RemoveChangeEventHandler
(
    le_gpioPin25_ChangeEventHandlerRef_t handlerRef
        ///< [IN]
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin25_SetEdgeSense
(
    le_gpioPin25_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin25_DisableEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin25_Edge_t le_gpioPin25_GetEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin25_Polarity_t le_gpioPin25_GetPolarity
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin25_PullUpDown_t le_gpioPin25_GetPullUpDown
(
    void
);

#endif // LE_GPIOPIN25_INTERFACE_H_INCLUDE_GUARD