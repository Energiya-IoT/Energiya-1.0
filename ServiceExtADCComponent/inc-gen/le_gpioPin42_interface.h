...
#ifndef LE_GPIOPIN42_INTERFACE_H_INCLUDE_GUARD
#define LE_GPIOPIN42_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_gpioPin42_DisconnectHandler_t)(void *);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin42_ConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin42_TryConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin42_SetServerDisconnectHandler
(
    le_gpioPin42_DisconnectHandler_t disconnectHandler,
    void *contextPtr
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin42_DisconnectService
(
    void
);
...
typedef enum
{
    LE_GPIOPIN42_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    LE_GPIOPIN42_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
le_gpioPin42_Polarity_t;
...
typedef enum
{
    LE_GPIOPIN42_EDGE_NONE = 0,
        ///< No edge detection
    LE_GPIOPIN42_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    LE_GPIOPIN42_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    LE_GPIOPIN42_EDGE_BOTH = 3
...
//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'le_gpioPin42_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct le_gpioPin42_ChangeEventHandler* le_gpioPin42_ChangeEventHandlerRef_t;
...
typedef enum
{
    LE_GPIOPIN42_PULL_OFF = 0,
        ///< Neither resistor is enabled
    LE_GPIOPIN42_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    LE_GPIOPIN42_PULL_UP = 2
        ///< Pullup resistor is enabled
}
le_gpioPin42_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_gpioPin42_ChangeCallbackFunc_t)
(
    bool state,
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'le_gpioPin42_ChangeEvent'
 *
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'le_gpioPin42_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin42_RemoveChangeEventHandler
(
    le_gpioPin42_ChangeEventHandlerRef_t handlerRef
        ///< [IN]
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin42_SetEdgeSense
(
    le_gpioPin42_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin42_DisableEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin42_Edge_t le_gpioPin42_GetEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin42_Polarity_t le_gpioPin42_GetPolarity
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin42_PullUpDown_t le_gpioPin42_GetPullUpDown
(
    void
);

#endif // LE_GPIOPIN42_INTERFACE_H_INCLUDE_GUARD