...
#ifndef LE_GPIOPIN13_INTERFACE_H_INCLUDE_GUARD
#define LE_GPIOPIN13_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_gpioPin13_DisconnectHandler_t)(void *);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin13_SetServerDisconnectHandler
(
    le_gpioPin13_DisconnectHandler_t disconnectHandler,
    void *contextPtr
);
...
typedef enum
{
    LE_GPIOPIN13_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    LE_GPIOPIN13_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
le_gpioPin13_Polarity_t;
...
typedef enum
{
    LE_GPIOPIN13_EDGE_NONE = 0,
        ///< No edge detection
    LE_GPIOPIN13_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    LE_GPIOPIN13_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    LE_GPIOPIN13_EDGE_BOTH = 3
...
//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'le_gpioPin13_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct le_gpioPin13_ChangeEventHandler* le_gpioPin13_ChangeEventHandlerRef_t;
...
typedef enum
{
    LE_GPIOPIN13_PULL_OFF = 0,
        ///< Neither resistor is enabled
    LE_GPIOPIN13_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    LE_GPIOPIN13_PULL_UP = 2
        ///< Pullup resistor is enabled
}
le_gpioPin13_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_gpioPin13_ChangeCallbackFunc_t)
(
    bool state,
...
(
    le_gpioPin13_ChangeEventHandlerRef_t handlerRef
        ///< [IN]
);
...
#endif // LE_GPIOPIN13_INTERFACE_H_INCLUDE_GUARD