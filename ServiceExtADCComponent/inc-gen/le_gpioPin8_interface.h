...
#ifndef LE_GPIOPIN8_INTERFACE_H_INCLUDE_GUARD
#define LE_GPIOPIN8_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_gpioPin8_DisconnectHandler_t)(void *);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin8_ConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin8_TryConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin8_SetServerDisconnectHandler
(
    le_gpioPin8_DisconnectHandler_t disconnectHandler,
    void *contextPtr
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin8_DisconnectService
(
    void
);
...
typedef enum
{
    LE_GPIOPIN8_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    LE_GPIOPIN8_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
le_gpioPin8_Polarity_t;
...
typedef enum
{
    LE_GPIOPIN8_EDGE_NONE = 0,
        ///< No edge detection
    LE_GPIOPIN8_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    LE_GPIOPIN8_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    LE_GPIOPIN8_EDGE_BOTH = 3
...
//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'le_gpioPin8_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct le_gpioPin8_ChangeEventHandler* le_gpioPin8_ChangeEventHandlerRef_t;
...
typedef enum
{
    LE_GPIOPIN8_PULL_OFF = 0,
        ///< Neither resistor is enabled
    LE_GPIOPIN8_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    LE_GPIOPIN8_PULL_UP = 2
        ///< Pullup resistor is enabled
}
le_gpioPin8_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_gpioPin8_ChangeCallbackFunc_t)
(
    bool state,
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'le_gpioPin8_ChangeEvent'
 *
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'le_gpioPin8_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin8_RemoveChangeEventHandler
(
    le_gpioPin8_ChangeEventHandlerRef_t handlerRef
        ///< [IN]
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin8_SetEdgeSense
(
    le_gpioPin8_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin8_DisableEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin8_Edge_t le_gpioPin8_GetEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin8_Polarity_t le_gpioPin8_GetPolarity
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin8_PullUpDown_t le_gpioPin8_GetPullUpDown
(
    void
);

#endif // LE_GPIOPIN8_INTERFACE_H_INCLUDE_GUARD